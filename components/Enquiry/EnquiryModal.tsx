...
const SELECT_CLASS =
  "w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none focus:border-amber-400";
...
const LABEL_CLASS = "text-[11px] font-semibold text-zinc-300 uppercase block mb-1";

const SUBMIT_BTN_CLASS =
  "w-full py-3.5 rounded-xl bg-linear-to-r from-amber-400 via-amber-500 to-amber-600 text-black font-bold uppercase tracking-wider text-xs shadow-lg shadow-amber-500/30 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-2 mt-2";
...
export default function EnquiryModal({
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/55 backdrop-blur-sm overflow-y-auto scrollbar-thin">
        <motion.div
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="text"
                            required
                            placeholder="e.g. Karthik & Ananya"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Ruler className="w-4 h-4 text-zinc-500 absolute left-3 top-3" />
                          <select
                    ...
                    {/* Variable Price Note */}
                    <p className="text-[11px] text-zinc-400 font-light italic flex items-center gap-1.5 pt-1">
